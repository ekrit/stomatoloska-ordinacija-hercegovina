...
# **patientGet**
> PatientResponsePagedResult patientGet(userId, firstName, lastName, phone, FTS, page, pageSize, includeTotalCount, retrieveAll)
...
try {
    final result = api_instance.patientGet(userId, firstName, lastName, phone, FTS, page, pageSize, includeTotalCount, retrieveAll);
    print(result);
} catch (e) {
