...
part 'model/appointment_stats_response.dart';
...
part 'model/dashboard_stats_response.dart';
part 'model/doctor_response.dart';
part 'model/doctor_response_paged_result.dart';
part 'model/doctor_spotlight_response.dart';
...
part 'model/monthly_appointment_response.dart';
...
part 'model/patient_stats_response.dart';
part 'model/patient_upsert_request.dart';
part 'model/payment_capture_response.dart';
part 'model/payment_order_create_request.dart';
part 'model/payment_order_create_response.dart';
...
part 'model/product_category_response.dart';
part 'model/product_category_response_paged_result.dart';
part 'model/product_category_upsert_request.dart';
part 'model/product_interaction_track_request.dart';
part 'model/product_response.dart';
part 'model/product_response_paged_result.dart';
part 'model/product_upsert_request.dart';
part 'model/recent_activity_response.dart';
part 'model/recommended_product_response.dart';
part 'model/report_response.dart';
part 'model/report_response_paged_result.dart';
part 'model/report_upsert_request.dart';
part 'model/revenue_category_response.dart';
part 'model/revenue_stats_response.dart';
...
part 'model/user_notification_response.dart';
