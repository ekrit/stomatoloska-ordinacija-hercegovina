...
builder.Services.AddScoped<IAppointmentStatusTypeService, AppointmentStatusTypeService>();
builder.Services.AddScoped<IPaymentStatusTypeService, PaymentStatusTypeService>();
