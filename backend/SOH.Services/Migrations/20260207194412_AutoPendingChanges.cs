...
{
    /// <inheritdoc />
    public partial class AutoPendingChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrushesCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HygieneTrackers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HygieneTrackers_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HygieneTrackers_PatientId",
