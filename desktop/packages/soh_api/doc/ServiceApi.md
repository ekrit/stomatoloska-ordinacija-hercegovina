...
# **serviceGet**
> ServiceResponsePagedResult serviceGet(name, FTS, page, pageSize, includeTotalCount, retrieveAll)
...
try {
    final result = api_instance.serviceGet(name, FTS, page, pageSize, includeTotalCount, retrieveAll);
    print(result);
} catch (e) {
