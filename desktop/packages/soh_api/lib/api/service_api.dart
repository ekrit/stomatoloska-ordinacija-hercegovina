...
class ServiceApi {
  ...
  Future<Response> serviceGetWithHttpInfo({ String? name, String? FTS, int? page, int? pageSize, bool? includeTotalCount, }) async {
  ...
  ///
  /// * [bool] includeTotalCount:
  Future<ServiceResponsePagedResult?> serviceGet({ String? name, String? FTS, int? page, int? pageSize, bool? includeTotalCount, }) async {
    final response = await serviceGetWithHttpInfo( name: name, FTS: FTS, page: page, pageSize: pageSize, includeTotalCount: includeTotalCount, );
